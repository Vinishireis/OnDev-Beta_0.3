...
<div class="container-cards">
    <article class="card">
        <h2>Premium</h2>
        <var><abbr>R$</abbr>0<small>/Mês</small></var>
        <ul>
            <li>
                <img src="assets/img/check (1).svg" />
                <p>Maior Visibilidade</p>
            </li>
            <li>
                <img src="assets/img/check (1).svg" />
                <p>Maiores Solicitações na plataforma</p>
            </li>
            <li>
                <img src="assets/img/check (1).svg" />
                <p>Suporte 24 Hrs</p>
        ...
        <div class="btn-group justify-content-center justify-content-md-start">
                                <a href="payment_screen.php" class="btn btn-border btn-with-icon btn-small ripple">
