...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($email_developer && $email_consumer) {
        try {
            ...
            // Insere os dados na tabela de serviços contratados
            $query = "INSERT INTO tb_servicos_contratados (service_id, user_id, developer_id, data_contratacao, status) VALUES (?, ?, ?, NOW(), 'em aberto')";
